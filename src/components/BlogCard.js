...
const BlogCard = ({ title, author, time, link, onClick, value }) => {
    return (
        <div onClick={onClick} className="flex sm:flex-col  cursor-pointer ">
            <div className="flex-1 p-2"><img className="w-full h-full object-cover object-center" src="/blog.png" alt="Blog" /></div>
            <div className="flex-1 p-2">
                <div className="font-bold text-[#0A66C2] text-xl line-clamp-2 mb-2">{title}</div>
                <p className="text-gray-700 dark:text-gray-300 text-base line-clamp-1">{author}</p>
